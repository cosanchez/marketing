            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5"><?php
echo $revisar[0]['revisar'] . ' ';
?>Nodos por Revisar!</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="" data-toggle="modal" data-target="#myModalR">
...
<?php
$cont = 0;
//SELECT DATEDIFF((select FechaCaducidad from productos where productos.IdP = '1'),curdate());
foreach ($campañas as $key => $value) {
    if ($value['Descripcion'] == 'REVISION') {
        $cont = $cont + 1;
    }
...
if ($cont == 0) {
    ...
    echo ' <div clas="mr-5">' . $cont . ' Campañas Por Revisar</div>';
}
?>
...
foreach ($campañas as $cpanas) {
    ?>
                      <tr>
                        <?php
if ($cpanas['Descripcion'] == 'REVISION') {?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                   <?php
foreach ($inforevisar as $cpanas) {
    ?>
                      <tr>
                        <td ><?php echo $cpanas['NombreCampana']; ?> </td>
                        <td ><?php echo $cpanas['Nodo']; ?> </td>
                        <td ><?php echo "<a class='fa fa-eye' aria-hidden='true'
                          href='index.php/welcome/CMRevision/" . $_SESSION['IdUsuario'] . "'></a>" ?></td>
                    </tr>
